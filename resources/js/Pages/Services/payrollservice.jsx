      ...
      <div className="relative h-48 w-full bg-muted/50">
        ...
        <div className="container mx-auto px-4">
          <div className="relative pt-20">
            <h1 className="text-3xl font-bold">Payroll & Registration</h1>
            <nav className="mt-4">
              <ol className="flex text-sm">
                ...
                <li className="">Payroll & Registration</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <Card className="border-none shadow-md bg-muted/50">
              <CardHeader>
                <CardTitle className="text-2xl font-bold">Payroll & Registration</CardTitle>
              </CardHeader>
