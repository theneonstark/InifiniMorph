        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <Card className="border-none shadow-md bg-muted/50">
              <CardHeader>
                <CardTitle className="text-2xl font-bold">SEO & Marketing</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <p>
                Our SEO & Digital Marketing services are essential for boosting your online visibility, attracting the right audience, and driving meaningful business growth. We focus on crafting data-driven strategies that enhance search rankings, optimize content, and maximize your brand’s impact across digital platforms.
                </p>
                <p>
                We blend strategic thinking with creative execution to develop campaigns that are not only visually compelling but also conversion-focused. From SEO audits and keyword optimization to targeted ad campaigns and social media management, our team works closely with clients to understand their market and tailor solutions that deliver real results.
                </p>

                {/* Blockquote */}
                <div className="rounded-lg border-l-4 p-4">
                  <p className="italic">
                  “Good marketing gets noticed. Great marketing gets remembered. Our goal is to create seamless, authentic digital experiences that connect with users and drive measurable success.”
                  </p>
                </div>
